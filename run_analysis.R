...
getwd()
#[1] "C:/Users/Daniel Criollo/Desktop/R"
...
setwd("C:/Users/Daniel Criollo/Desktop/R/UCI HAR Dataset/")
activityLabels <- read.table("activity_labels.txt", header = FALSE)
featureNames <- read.table("features.txt", header = FALSE)

## reset wd() ##
setwd("C:/Users/Daniel Criollo/Desktop/R/UCI HAR Dataset/test") 
...
## reset wd() ##
setwd("C:/Users/Daniel Criollo/Desktop/R/UCI HAR Dataset/train") 
list.files(getwd(),pattern=".*.txt")
